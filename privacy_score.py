...
class PrivacyScore:
    ...
    def set_initial_weights(self):
        ...
        if self.data_distribution == 'centralized':
            self.distribution_penalty = 0.1 # Penalize centralized data distribution
        ...
        self.access_control = encryption_weights.get(self.encryption, 0.9)  # Default to most penalizing if unknown
    ...
    def calculate_score(self, **metrics):
        ...
        # Penalize for centralized data distribution and low encryption
        total_score += self.distribution_penalty
        total_score += self.access_control
